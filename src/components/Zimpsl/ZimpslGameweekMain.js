...
import { listZimpslByGameweek, listZimpslGameweeks } from "../../Redux/Actions/ZimpslActions";
...
const ZimpslGameweekMain = (props) => {
    ...
    useEffect(() => {
        ...
        dispatch(listZimpslByGameweek(gameweek));
        dispatch(listZimpslGameweeks());
    }, [dispatch, successDelete, gameweek]);
...
export default ZimpslGameweekMain;